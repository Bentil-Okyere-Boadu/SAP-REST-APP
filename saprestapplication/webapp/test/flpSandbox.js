		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP REST Application",
									"targetURL": "#saprestapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saprestapplication-display": {
								"semanticObject": "saprestapplication",
								"action": "display",
								"description": "A Fiori application that is connected to a REST API",
								"title": "SAP REST Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=saprestapplication",
									"url": sap.ui.require.toUrl("saprestapplication")
								}
							}
						}
					}
